...
function onLoadingFinished() {
    ...
    script.topK = Math.min(script.topK, classCount);

    topKLabels = new Array(script.topK);
    topKScores = new Array(script.topK);
    ...
    if (result[0].score > script.threshold + eps) {
        ...
        if (prevClass != curClass) {
            ...
            if (script.useBehavior) {
                ...
                print(script.customTriggerPrefixFound + labels[curClass]);            
            }
        }
